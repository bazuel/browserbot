...
export interface DOMJson {
    ...
    id?: number
    shadow?: {
        children: DOMJson[], mode: 'open' | 'closed', style: string
        documentFragment?: DOMJson
        shadowType?: 'document-fragment' | 'shadow-dom'
    } //for web-components
    type: "#document-fragment" | "error" | "svg" | "comment" | "cdata" | "audio" | "video" | "text" | "script-text" | "css-text" | "canvas" | "input" | "textarea" | "select" | "option" | "web-component" | "document" | "doc-type" | "style" | "link-stylesheet" | string
...
export interface BLMutationEventData extends Partial<DOMJson> {
    name: 'mutation-attribute' | 'mutation-add' | 'mutation-remove' | 'mutation-text' | 'mutation-style'
    text?: string
    children?: DOMJson[]

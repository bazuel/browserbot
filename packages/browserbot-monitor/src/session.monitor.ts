...
import { getElementAttributes, getElementRect } from './serialize-target';
...
import { BLEvent, BLEventWithTarget, BLSessionEvent } from './events';
...
export class SessionMonitor {
  ...
  private setupDispatchers() {
    ...
    //used only for document "element" (mouse-scroll)

export class LazyImagesRefresherApi {
    ...
    refreshLazyImages(iframe: HTMLIFrameElement, options = {skipVisibleAreaCheck: false}) {
    ...
    manageLazyImage(node: HTMLImageElement, json: { width?: number, height?: number, attributes?: { src?: string } }) {
